...
//Read input informations
  ...
  ReadInput >> temp;
  beta = 1.0/temp;
  cout << "Temperature = " << temp*120 <<" K"<< endl;
  ...
  ReadInput >> rcut;
  cout << "Cutoff of the interatomic potential = " << rcut * 0.00000000034 << " m"<< endl << endl;
  ...
  cout << "Moves parameter = " << delta * 0.00000000034 << " m"<< endl;
...
//Read initial configuration
  ...
  cout << "System thermalisation: moving 5000 steps" << endl << endl;
  ...
  cout << "System thermalised" << endl << endl; 
...
/*  if (trigger == 1){
  	energia.open("500000.epot.gas",ios::app);
  	pressione.open("500000.pres.gas",ios::app);

  	energia<< "		"<<walker[iv]<<endl;
  	pressione<<"		"<<walker[iw]<<endl;
...
//   double r, gdir;
   ...
   const int wd=12;
    ...
    Epot.open("argon.epot.solid",ios::app);
    Pres.open("argon.pres.solid",ios::app);
    Gofr.open("argon.gofr.solid",ios::app);
...
//Potential energy per particle
    Epot << setw(wd) << iblk <<  setw(wd) << stima_pot *120 << setw(wd) << glob_av[iv]/(double)iblk *120<< setw(wd) << err_pot *120<< endl;
//Pressure
    double Pargon = 1.2*1.38*pow(10,9)/pow(3.4,3);
    Pres << setw(wd) << iblk <<  setw(wd) << stima_pres *Pargon<< setw(wd) << glob_av[iw]/(double)iblk  *Pargon<< setw(wd) << err_press  *Pargon<< endl;
